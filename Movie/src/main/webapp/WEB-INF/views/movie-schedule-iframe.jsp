                    ...
                    <div class="time_line">
                        <div class="time_noData">
          		         ...
          		         <div style="display: block;" id=siNamesub>
                        	...
                        	<dl class="">    <dt>        <span class="grade_${movieList.MV_GRADE}">${movieList.MV_GRADE}</span>${movieList.MV_NAME}          </dt>  
                        				      ...
                        				      <c:choose>
                        				           <c:when test="${movieListTime.SS_STARTTIME le '10:00' }">
                        				               <span class="clock"><em class="seat iri">조조</em>${movieListTime.SS_STARTTIME}<span> ~ ${movieListTime.SS_ENDTIME}</span></span>
                        				           	 <span class="ppNum"><em class="color_brown" title="좌석 확인"> ${movieListTime.STYPE_NUM-movieListTime.SS_ATTENDANCE}</em>석 / ${movieListTime.STYPE_NUM}석</span></a></li>
                        				           </c:when>
